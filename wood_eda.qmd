...
The complex interplay among water, rocks, and trees is fundamental to habitat dynamics in rivers, generating the "beautiful messiness" that supports a rich and abundant riverscape biota (Scott et al. 2022). 

Oversimplification of these interactions through wood removal, channel straightening, and floodplain disconnection has degraded habitat, particularly in long-altered, temperate, forested watersheds. 

In recent decades, such degradation has prompted the active reintroduction of logs and various forms of engineered jams in the western United States, typically intended to benefit aquatic organisms via increased structural diversity (Roni et al. 2015, Ockelford et al. 2024).

Much has been learned from such projects, and consensus has emerged around several general principles: avoid unsuitable locations, designs, and fixed targets for piece counts, while ensuring monitoring and follow-up, especially to address the secondary effects of initial interventions (e.g., Tables 3 and 4 in Ockelford et al. 2024). 

Yet practicable, quantitative management guidelines are still an area of active research, in part due to the logistical challenges of consistent measurement over many years at watershed extents (e.g., Hassan 2022, Martens & Devine 2022, Scott 2024, Ruiz-Villanueva et al. 2024).  

The 'natural wood regime' articulated by Wohl et al. (2019) offers a cogent, coherent theoretical framework to organize such guidance, describing recruitment, storage, and transport processes, each varying in magnitude, duration, frequency, timing, and rate of change.

But the authors of this paradigm also note, "However, until more data are available to accurately parameterize mechanistic, multiscale models of wood regimes across regions (Scott and Wohl 2018), characterizing wood regimes over broad spatial scales will remain difficult" (Wohl et al. 2019).

This paper seeks to reduce uncertainties in how wood density varies in space and time throughout drainage network by analyzing data collected between 2007 and 2024 at *NNN* consistently surveyed reaches within *NNN* small independent basins in western Washington, USA. These data were collected as part of the Intensively Monitored Watersheds (IMW) program, a long-term, multi-location, collaborative evaluation of the population-level effects of habitat rehabilitation practices for Pacific salmon recovery (Bilby et al. 2005; Bennett et al. 2016; Krueger et al. *in prep*). Physical and biological measurements throughout 3-4 neighboring stream networks within each of three IMW 'complexes' enable watershed-scale comparisons of the factors affecting and limiting salmonids in forested basins of the Pacific Northwest (Roni 2005; Bilby et al. 2023).

Within the broader, motivating question of "how can we most effectively define 'target wood regimes' (sensu Wohl et al. 2019) that are formulated to reverse impairments and meet ecosystem service goals?", we deploy a powerful spatiotemporal modeling approach to ask whether basic topographic attributes that are widely available in public hydrography datasets can consistently predict the "woodscape" of characteristic loads and fluxes. 
