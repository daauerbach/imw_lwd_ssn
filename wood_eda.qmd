...
```{r rc_confinement_vbet}
#can prob get some values for all sites
#but either need different RC product or work to translate into something suited for per-site attribution

st_layers(file.path(dir_data_common, "rc", "Confinement-Confinement_for_Salt_Creek-Frontal_Strait_of_Juan_De_Fuca", "outputs/confinement.gpkg"))

x <- st_read(file.path(dir_data_common, "rc", "Confinement-Confinement_for_Salt_Creek-Frontal_Strait_of_Juan_De_Fuca", "outputs/confinement.gpkg"), 
             layer = "confining_margins"); mapview::mapview(x)
x <- st_read(file.path(dir_data_common, "rc", "Confinement-Confinement_for_Salt_Creek-Frontal_Strait_of_Juan_De_Fuca", "outputs/confinement.gpkg"), 
             layer = "confinement_dgos"); mapview::mapview(x)

st_layers(file.path(dir_data_common, "rc", "VBET-Valley_Bottom_for_Salt_Creek-Frontal_Strait_of_Juan_De_Fuca", "outputs/vbet.gpkg"))
x <- st_read(file.path(dir_data_common, "rc", "VBET-Valley_Bottom_for_Salt_Creek-Frontal_Strait_of_Juan_De_Fuca", "outputs/vbet.gpkg"), 
             layer = "vbet_igos"); mapview::mapview(x)
x <- st_read(file.path(dir_data_common, "rc", "VBET-Valley_Bottom_for_Salt_Creek-Frontal_Strait_of_Juan_De_Fuca", "outputs/vbet.gpkg"), 
             layer = "vbet_full"); mapview::mapview(x)
