...
Wood and its interactions with flow and sediment are fundamental to riverscape habitat dynamics. The 'natural wood regime' articulated by Wohl et al. (2019) describes recruitment, storage, and transport processes, each varying in magnitude, duration, frequency, timing, and rate of change. This wood regime paradigm recognizes historical and ongoing simplification of the complex interplay among trees, rocks, and water in stream networks, and it describes the consequent fluvial habitat degradation, particularly in long-altered, temperate, forested watersheds subject to wood removal, channel straightening, and floodplain disconnection. In recent decades, such degradation has prompted widespread reintroduction of logs and various forms of engineered jams in the western United States, typically intended to benefit aquatic organisms via increased habitat diversity (Roni et al. 2015, Ockelford et al. 2024).

Much has been learned from such projects, and consensus around general guidance has emerged, including avoidance of unsuitable locations and designs, inflexible piece count targets, and approaches that neglect monitoring and follow-up, especially around the secondary effects of initial interventions (e.g., Tables 3 and 4 in Ockelford et al. 2024). Yet practicable, quantitative management guidelines are still an area of active research, in part due to the logistical challenges of consistent measurements over long durations and diverse settings (e.g., Hassan 2022, Martens & Devine 2022, Scott 2024, Ruiz-Villanueva et al. 2024). Overcoming these challenges is necessary to reach a more systematized legal and policy framework of 'target wood regimes' formulated to reverse impairments and meet other ecosystem service goals (Wohl et al. 2019), in the context of existing instream or environmental flow rules and in conjunction with riparian and upland land management practices.

This paper examines spatial and temporal variation in large wood density, analyzing data collected between 2007 and 2024 at *NNN* consistently surveyed reaches within *NNN* small independent basins in western Washington, USA, and asking how measures relate to network position and topographic attributes *[and estimated discharge?]*. These data were collected as part of the Intensively Monitored Watersheds (IMW) program, a long-term, multi-location, collaborative evaluation of the population-level effects of habitat rehabilitation practices for Pacific salmon recovery (Bilby et al. 2005; Bennett et al. 2016; Krueger et al. *in prep*). Physical and biological data collected throughout 3-4 neighboring stream networks within each of three IMW 'complexes' enable watershed-scale comparisons of the factors affecting and limiting salmonids in small, forested basins of the Pacific Northwest (Roni 2005; Bilby et al. 2023).



numeric thresholds, ranges, etc.
